...
\begin{questionText}
A straight line on a coordinate plane passes through $(2, 6)$ and $(4, 12)$. Which could be the $y$-intercept?
\end{questionText}
\choiceA{$(0, 0)$}
\choiceB{$(0, 2)$}
\choiceC{$(0, -1)$}
...
\correctAnswer{A}
\explanation{The two given points determine the line uniquely: slope $= \frac{12-6}{4-2} = 3$, so using $(2,6)$ gives $6 = 3(2) + b$, which means $b = 0$. The line's $y$-intercept is $(0,0)$, so choice A is correct.}
\end{practiceQuestion}
