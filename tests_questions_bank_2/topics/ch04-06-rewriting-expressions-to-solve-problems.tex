...
\correctAnswer{A}
\explanation{First apply discount: $0.90b$. Then add tax: $1.07 \times 0.90b = 1.07(0.90b)$. The order matters because tax is on the discounted price.}
\end{practiceQuestion}
...
\correctAnswer{D}
\explanation{$0.75n = n - 0.25n$, meaning $25\%$ less than $n$. Equivalently, $0.75n$ is $75\%$ of $n$. Maria is incorrect about it being $75\%$ more.}
\end{practiceQuestion}
...
\end{questionText}
\correctAnswer{No. After increase: $1.03p$. After decrease: $0.97(1.03p) = 1.0009p \neq p$. Actually $0.97 \times 1.03 = 0.9991$, so the population is $0.9991p$, which is slightly less than $p$.}
