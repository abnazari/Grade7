...
\end{center}
\end{questionText}
\correctAnswer{$a = 65°$, $b = 115°$}
\explanation{The $115°$ angle and angle $a$ form a linear pair on line $\ell_1$: $a = 180° - 115° = 65°$. Angle $b$ and the $115°$ angle are alternate interior angles (on opposite sides of the transversal between parallel lines), so $b = 115°$. Alternatively, $b$ and $a$ are co-interior angles: $a + b = 180°$, so $b = 115°$.}
\end{practiceQuestion}
