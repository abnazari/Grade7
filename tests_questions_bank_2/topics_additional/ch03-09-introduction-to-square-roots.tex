...
\end{questionText}
\correctAnswer{$8$ (since $8^2 = 64$ and $9^2 = 81$, and $72$ is closer to $64$, so $\approx 8.5$; nearest whole $= 8$ or $9$)}
\explanation{$8^2 = 64$ and $9^2 = 81$. $72 - 64 = 8$, $81 - 72 = 9$. Closer to $64$, so $\sqrt{72} \approx 8.5$. Nearest whole: $8$ or $9$ both acceptable.}
\end{practiceQuestion}
