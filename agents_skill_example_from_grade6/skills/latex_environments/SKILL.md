...
description: Complete reference of all custom LaTeX environments for Grade 6 math topics
---

# Grade 6 LaTeX Environments Reference
...
\end{proofBox}
```
Indigo box with pen-nib icon and left accent bar. For introducing basic mathematical reasoning and justifications. Ideal for Grade 6 students beginning formal reasoning skills.
...
\end{strategyBox}
```
Teal box with lightbulb icon and left accent bar. For teaching problem-solving strategies and systematic approaches. Ideal for Grade 6 students developing independent problem-solving skills.
